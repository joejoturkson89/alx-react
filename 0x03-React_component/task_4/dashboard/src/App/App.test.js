...
describe("Testing <App logOut={function} />", () => {
  ...
  it("verify that when the keys control and h are pressed the logOut function, passed as a prop, is called and the alert function is called with the string Logging you ouP1+r[24~\P0+r\P0+r\P1+r\P0+r\P1+r[3~\P1+rOH\t", () => {
